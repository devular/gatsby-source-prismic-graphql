...
- update package.json ([c3acfd8](https://github.com/devular/gatsby-source-prismic-graphql/commit/c3acfd8))

### Features

- attp 3 ([57f97e2](https://github.com/devular/gatsby-source-prismic-graphql/commit/57f97e2))
